...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{../figures/vote_cov_mat_pca.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{../figures/vote_cov_lr_pca.png}
